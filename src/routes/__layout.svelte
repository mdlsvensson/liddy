	...
	<header class="w-16 h-full bg-fg flex flex-col gap-6 items-center">
		...
		<nav class="flex flex-col h-full items-center w-12 gap-2">
			...
			>
				...
				>
				<div
					class="absolute invisible opacity-0 rounded bg-yellow transition left-16 top-1 p-2 duration-500 group-hover:opacity-100 group-hover:visible"
				>
			...
			>
				...
				<div
					class="absolute invisible opacity-0 rounded bg-green2 transition left-16 top-1 p-2 duration-500 group-hover:opacity-100 group-hover:visible"
				>
